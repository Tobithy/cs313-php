...
CREATE TABLE user_account (
    ...
    data_display_pref_id    integer         REFERENCES data_display_pref (data_display_pref_id)
);

CREATE TABLE clinical_test (
    clinical_test_id            serial          PRIMARY KEY     ,
    clinical_test_short_name    varchar(16)     NOT NULL UNIQUE ,
...
CREATE TABLE clinical_data (
    ...
    clinical_test_id        integer         REFERENCES clinical_test (clinical_test_id),
    data_float              real                            ,
